...
lsites = [{'label': 'All Sites', 'value': 'ALL'}] + [{'label': site, 'value': site} for site in launch_sites]
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site_dropdown', options=lsites, placeholder='Select a Launch Site', searchable = True , value = 'ALL'),
                                html.Br(),
